...
iso_capture: src/iso_capture.c src/hd60s_util.c
	$(CC) $(CFLAGS) -Isrc $(LIBUSB_CFLAGS) $(PIPEWIRE_CFLAGS) src/iso_capture.c src/hd60s_util.c -o $@ $(LIBUSB_LIBS) $(ALSA_LIBS) $(PIPEWIRE_LIBS) -lpthread -lsamplerate
