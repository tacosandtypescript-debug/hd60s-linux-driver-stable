...
iso_capture: src/iso_capture.c src/hd60s_util.c src/hd60s_v4l2.c
	$(CC) $(CFLAGS) -Isrc $(LIBUSB_CFLAGS) $(PIPEWIRE_CFLAGS) src/iso_capture.c src/hd60s_util.c src/hd60s_v4l2.c -o $@ $(LIBUSB_LIBS) $(ALSA_LIBS) $(PIPEWIRE_LIBS) -lpthread -lsamplerate
