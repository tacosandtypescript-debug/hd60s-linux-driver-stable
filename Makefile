...
install: iso_capture
	...
	install -m 0755 iso_capture scripts/hd60s scripts/hd60s-lib.sh scripts/hd60s-capture.sh scripts/hd60s-audio-bridge.sh scripts/hd60s-obs-setup.sh scripts/hd60s-wait-ready.sh "$(DESTDIR)$(LIBEXECDIR)/"
